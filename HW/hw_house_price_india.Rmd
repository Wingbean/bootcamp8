...
## After train model use real price vs logarithm price, now find out the important variable for tuning the new model("model_log_s") for lower error or high accuracy
```{r echo=FALSE}
